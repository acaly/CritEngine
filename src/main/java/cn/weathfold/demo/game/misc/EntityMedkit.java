 ...
 *
 */
public class EntityMedkit extends EntityObstacle
{
  ...
  {
    Set<Entity> entities = this.sceneObj.getEntitiesWithin(getGeomProps(), PlayerFilter.INSTANCE, new Entity[0]);
    if (!entities.isEmpty()) {
  ...
  public void drawEntity()
  {
	  GL11.glPushMatrix();
	    ...
	    CERenderEngine.bindTexture(SceneGame.TEX_MEDKIT);
